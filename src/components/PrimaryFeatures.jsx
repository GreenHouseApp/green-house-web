...
const features = [
  ...
  {
    name: 'Enjoy live events hosted by best',
    description:
      'Immerse yourself in the next level social experiences hosted by some of the biggest names in the cannabis industry.  Thought leaders, comedians, chefs, musicians, and many more to come.',

    icon: '/location.png',
    screen: StocksScreen,
  },
  {
    name: 'Chop it up with the homies',
    description:
      'We integrated a messaging platform in our app for you to message the people you connect with. Get to know the people on our platform then invite them for a sesh to create some stimulating interactions.',
