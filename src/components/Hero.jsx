  ...
  return (
    ...
    >
      ...
      <motion.path
        ...
        {...(isInView ? { stroke: '#32B66C', animate: { pathLength: 1 } } : {})}
        onUpdate={({ pathLength }) => {
          pathWidth.set(
...
export function Hero() {
  return (
    <div className="overflow-hidden bg-black py-20 sm:py-32 lg:pb-32 xl:pb-36">
      <Container>
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
          <div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
            <h1 className="text-4xl font-medium text-white tracking-tight">
            Cannabis Industry’s first interactive video group chat app
            </h1>
            <p className="mt-6 text-lg text-gray-300">
              Use cannabis in real time with anyone from other cities, states,
              and countries. Use our interactive smoke rooms to host a sesh and
              catch a vibe, or to elevate your high and engage in stimulating
              content.
            </p>
            <div className="mt-8 flex flex-wrap gap-x-6 gap-y-4">
              ...
              >
                ...
                <span className="text-white ml-2.5">Enter the Experience</span>
              </Button>
            </div>
          </div>
